...
public class AChickenBloodEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;


	public AChickenBloodEntity(EntityType<AChickenBloodEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		if(ModList.get().isLoaded("evilcraft")){
			this.spawnAtLocation(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("evilcraft:blood_orb_filled"))));
		}
		else {
