...
import net.tarantel.chickenroost.entity.mods.aetwo.*;
import net.tarantel.chickenroost.entity.mods.allthemodium.*;
...
import net.tarantel.chickenroost.entity.mods.silentgems.*;
...
public class ModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBloodEntity>> A_CHICKEN_BLOOD = registerMonster("c_blood",AChickenBloodEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenRedEntity>> A_CHICKEN_RED = registerMob("c_red",AChickenRedEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenYellowEntity>> A_CHICKEN_YELLOW = registerMob("c_yellow",AChickenYellowEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenWhiteEntity>> A_CHICKEN_WHITE = registerMob("c_white",AChickenWhiteEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenOrangeEntity>> A_CHICKEN_ORANGE = registerMob("c_orange",AChickenOrangeEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenMagentaEntity>> A_CHICKEN_MAGENTA = registerMob("c_magenta",AChickenMagentaEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenLightBlueEntity>> A_CHICKEN_LIGHT_BLUE = registerMob("c_light_blue",AChickenLightBlueEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenLimeEntity>> A_CHICKEN_LIME = registerMob("c_lime",AChickenLimeEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenPinkEntity>> A_CHICKEN_PINK = registerMob("c_pink",AChickenPinkEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenGrayEntity>> A_CHICKEN_GRAY = registerMob("c_gray",AChickenGrayEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenLightGrayEntity>> A_CHICKEN_LIGHT_GRAY = registerMob("c_light_gray",AChickenLightGrayEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenCyanEntity>> A_CHICKEN_CYAN = registerMob("c_cyan",AChickenCyanEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenPurpleEntity>> A_CHICKEN_PURPLE = registerMob("c_purple",AChickenPurpleEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBrownEntity>> A_CHICKEN_BROWN = registerMob("c_brown",AChickenBrownEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenGreenEntity>> A_CHICKEN_GREEN = registerMob("c_green",AChickenGreenEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBlackEntity>> A_CHICKEN_BLACK = registerMob("c_black",AChickenBlackEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBotaniaLivingwoodEntity>> A_CHICKEN_BOTANIA_LIVINGWOOD = registerMob("c_livingwood",AChickenBotaniaLivingwoodEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenCrimstonStemEntity>> A_CHICKEN_CRIMSTON_STEM = registerMonster("c_crimstonstem",AChickenCrimstonStemEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenWarpedStemEntity>> A_CHICKEN_WARPED_STEM = registerMonster("c_warpedstem",AChickenWarpedStemEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenWoolEntity>> A_CHICKEN_WOOL = registerMob("c_wool",AChickenWoolEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenSoulSandEntity>> A_CHICKEN_SOUL_SAND = registerMonster("c_soulsand",AChickenSoulSandEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenNetherrackEntity>> A_CHICKEN_NETHERRACK = registerMonster("c_netherrack",AChickenNetherrackEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenSoulSoilEntity>> A_CHICKEN_SOUL_SOIL = registerMonster("c_soulsoil",AChickenSoulSoilEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBasaltEntity>> A_CHICKEN_BASALT = registerMonster("c_basalt",AChickenBasaltEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenClayEntity>> A_CHICKEN_CLAY = registerMob("c_clay",AChickenClayEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenQuartzEntity>> A_CHICKEN_QUARTZ = registerMonster("c_quartz",AChickenQuartzEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenNetherStarEntity>> A_CHICKEN_NETHER_STAR = registerMob("c_netherstar",AChickenNetherStarEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenNetherWartEntity>> A_CHICKEN_NETHER_WART = registerMonster("c_netherwart",AChickenNetherWartEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenEnderEyeEntity>> A_CHICKEN_ENDER_EYE = registerMonster("c_endereye",AChickenEnderEyeEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenGlowstoneEntity>> A_CHICKEN_GLOWSTONE = registerMonster("c_glowstone",AChickenGlowstoneEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBlazeRodEntity>> A_CHICKEN_BLAZE_ROD = registerMonster("c_blazerod",AChickenBlazeRodEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBoneMealEntity>> A_CHICKEN_BONE_MEAL = registerMob("c_bonemeal",AChickenBoneMealEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenEnderPearlEntity>> A_CHICKEN_ENDER_PEARL = registerMonster("c_enderpearl",AChickenEnderPearlEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenBoneEntity>> A_CHICKEN_BONE = registerMonster("c_bone",AChickenBoneEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenPrismarineShardEntity>> A_CHICKEN_PRISMARINE_SHARD = registerMob("c_prismarineshard",AChickenPrismarineShardEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenNetherBrickEntity>> A_CHICKEN_NETHER_BRICK = registerMonster("c_netherbrick",AChickenNetherBrickEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenChorusFruitEntity>> A_CHICKEN_CHORUS_FRUIT = registerMonster("c_chorusfruit",AChickenChorusFruitEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenLeatherEntity>> A_CHICKEN_LEATHER = registerMob("c_leather",AChickenLeatherEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenStringEntity>> A_CHICKEN_STRING = registerMonster("c_string",AChickenStringEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenmelonEntity>> A_CHICKENMELON = registerMob("c_melon",AChickenmelonEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenmagmacreamEntity>> A_CHICKENMAGMACREAM = registerMonster("c_magmacream",AChickenmagmacreamEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenblazepowderEntity>> A_CHICKENBLAZEPOWDER = registerMonster("c_blazepowder",AChickenblazepowderEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickentintedglassEntity>> A_CHICKENTINTEDGLASS = registerMob("c_tintedglass",AChickentintedglassEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickennetheriteEntity>> A_CHICKENNETHERITE = registerMonster("c_netherite",AChickennetheriteEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenbeetrootEntity>> A_CHICKENBEETROOT = registerMob("c_beetroot",AChickenbeetrootEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenspidereyeEntity>> A_CHICKENSPIDEREYE = registerMonster("c_spidereye",AChickenspidereyeEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickencarrotEntity>> A_CHICKENCARROT = registerMob("c_carrot",AChickencarrotEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenrottenEntity>> A_CHICKENROTTEN = registerMonster("c_rotten",AChickenrottenEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenghasttearEntity>> A_CHICKENGHASTTEAR = registerMonster("c_ghasttear",AChickenghasttearEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenUnobtainiumEntity>> A_CHICKEN_UNOBTAINIUM = registerMob("c_unobtainium",AChickenUnobtainiumEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	public static final DeferredHolder<EntityType<?>, EntityType<AChickenEndstoneEntity>> A_CHICKEN_ENDSTONE = registerMonster("c_endstone",AChickenEndstoneEntity::new,
			0.4f, 0.7f, 0x302219, 0xACACAC);
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(A_CHICKEN_BLOOD.get(), AChickenBloodEntity.createAttributes().build());
		event.put(A_CHICKEN_RED.get(), AChickenRedEntity.createAttributes().build());
		event.put(A_CHICKEN_YELLOW.get(), AChickenYellowEntity.createAttributes().build());
		event.put(A_CHICKEN_WHITE.get(), AChickenWhiteEntity.createAttributes().build());
		event.put(A_CHICKEN_ORANGE.get(), AChickenOrangeEntity.createAttributes().build());
		event.put(A_CHICKEN_MAGENTA.get(), AChickenMagentaEntity.createAttributes().build());
		event.put(A_CHICKEN_LIGHT_BLUE.get(), AChickenLightBlueEntity.createAttributes().build());
		event.put(A_CHICKEN_LIME.get(), AChickenLimeEntity.createAttributes().build());
		event.put(A_CHICKEN_PINK.get(), AChickenPinkEntity.createAttributes().build());
		event.put(A_CHICKEN_GRAY.get(), AChickenGrayEntity.createAttributes().build());
		event.put(A_CHICKEN_LIGHT_GRAY.get(), AChickenLightGrayEntity.createAttributes().build());
		event.put(A_CHICKEN_CYAN.get(), AChickenCyanEntity.createAttributes().build());
		event.put(A_CHICKEN_PURPLE.get(), AChickenPurpleEntity.createAttributes().build());
		event.put(A_CHICKEN_BROWN.get(), AChickenBrownEntity.createAttributes().build());
		event.put(A_CHICKEN_GREEN.get(), AChickenGreenEntity.createAttributes().build());
		event.put(A_CHICKEN_BLACK.get(), AChickenBlackEntity.createAttributes().build());
		event.put(A_CHICKEN_LAVA.get(), AChickenLavaEntity.createAttributes().build());
		event.put(A_CHICKEN_WATER.get(), AChickenWaterEntity.createAttributes().build());
