...
public class AChickenMagentaEntity extends Chicken {
    public int eggTime = this.random.nextInt(6000) + 6000;


    public AChickenMagentaEntity(EntityType<AChickenMagentaEntity> type, Level world) {
        super(type, world);
        xpReward = 0;
        setNoAi(false);
    ...
    protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
        ...
        this.spawnAtLocation(new ItemStack(ModItems.MAGENTA_EGG.get()));
    }
    @Override
    public void aiStep() {
        super.aiStep();
