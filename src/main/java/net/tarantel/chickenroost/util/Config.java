...
public class Config {
    ...
    public static ModConfigSpec.ConfigValue<Integer> roost_speed_tick = BUILDER.comment("Defines the Roost Production Speed in Seconds:").define("roostspeed", 10);
    public static ModConfigSpec.ConfigValue<Integer> breed_speed_tick = BUILDER.comment("Defines the Breeding Speed in Seconds:").define("breederspeed", 15);
    public static ModConfigSpec.ConfigValue<Integer> training_speed_tick = BUILDER.comment("Defines the Training Speed in Seconds:").define("trainerspeed", 10);
    public static ModConfigSpec.ConfigValue<Integer> extractor_speedtimer = BUILDER.comment("Defines the Soul Extraction Speed in Seconds:").define("soulextractspeed", 5);
    public static ModConfigSpec.ConfigValue<Integer> soulbreed_speedtimer = BUILDER.comment("Defines the Soul Breeding Speed in Seconds:").define("soulbreedspeed", 10);
    public static ModConfigSpec.ConfigValue<Float> roostxp = BUILDER.comment("Defines the passive XP gained while Breeding or inside the Roost in Ratio like 0.1f = 10%").define("passivexp", 0.1f);
    public static ModConfigSpec.ConfigValue<Integer> food_xp_tier_1 = BUILDER.comment("Defines the XP Amount per Seed Tier:").define("seeds_tier_1", 50);
    ...
    public static ModConfigSpec.ConfigValue<Integer> xp_tier_1 = BUILDER.comment("Defines the XP required for a Levelup per Tier").define("xp_tier_1", 50);
    ...
    public static ModConfigSpec.ConfigValue<Integer> maxlevel_tier_1 = BUILDER.comment("Defines the max Level per Tier").define("level_tier_1", 128);
