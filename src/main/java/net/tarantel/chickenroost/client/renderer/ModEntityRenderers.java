...
public class ModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(ModEntities.A_CHICKEN_BLOOD.get(), AChickenBloodRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_RED.get(), AChickenRedRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_YELLOW.get(), AChickenYellowRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_WHITE.get(), AChickenWhiteRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_ORANGE.get(), AChickenOrangeRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_MAGENTA.get(), AChickenMagentaRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_LIGHT_BLUE.get(), AChickenLightBlueRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_LIME.get(), AChickenLimeRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_PINK.get(), AChickenPinkRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_GRAY.get(), AChickenGrayRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_LIGHT_GRAY.get(), AChickenLightGrayRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_CYAN.get(), AChickenCyanRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_PURPLE.get(), AChickenPurpleRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_BROWN.get(), AChickenBrownRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_GREEN.get(), AChickenGreenRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_BLACK.get(), AChickenBlackRenderer::new);

		event.registerEntityRenderer(ModEntities.A_CHICKEN_WATER.get(), AChickenWaterRenderer::new);
		event.registerEntityRenderer(ModEntities.A_CHICKEN_LAVA.get(), AChickenLavaRenderer::new);
